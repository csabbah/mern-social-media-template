...
export const ADD_LIKE_TO_REPLY = gql`
  mutation addLikeToReply(
    $userId: String!
    $commentId: String!
    $replyId: String!
  ) {
    addLikeToReply(userId: $userId, commentId: $commentId, replyId: $replyId) {
      __typename
      _id
      postId
      userId
...
export const UPDATE_INNER_REPLY = gql`
  mutation updateInnerReply(
    $text: String!
    $commentId: String!
    $replyId: String!
    $innerReplyId: String!
